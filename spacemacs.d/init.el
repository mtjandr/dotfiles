...
(defun user/bootstrap-emacs-config ()
  (shell-command (concat "git clone " user/spacemacs-repo " " user-emacs-directory))
...
(defun dotspacemacs/user-config ()
  ...
  ;; Add minted to default packages to include when exporting
  (add-to-list 'org-latex-packages-alist '("" "minted"))

  ;; Tell latex export to us minted package for source code highlighting
  (setq org-latex-listings 'minted)

  ;; Allow latex to run external programs (dangerous)
  (setq org-latex-pdf-process
      '("xelatex -shell-escape -interaction nonstopmode -output-directory %o %f"))

  ;; Allow code syntax highlighting in org-mode
